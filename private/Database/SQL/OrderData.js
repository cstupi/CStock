...
order.GetAllPendingMarketOrders = function(callback, failure){
	connection.query('SELECT o.OrderId, o.UserId, t.TransactionType, ot.OrderType, m.Status, o.ExpirationDate, o.ExecutionDate, o.CreationDate, o.Asset, o.Count, o.Price, o.GameId' +
		' FROM `Order` as o JOIN MarketStatus m ON m.MarketStatusId = o.Status JOIN TransactionType t ON o.TransactionType = t.TransactionTypeId' + 
		' JOIN OrderType ot ON ot.OrderTypeId = o.OrderType WHERE m.MarketStatusId = ? AND o.OrderType = ?',[1,1],function(error, results, fields){
			if(error){
				if(failure)
					failure();
				throw error;
...
order.GetOrder = function(orderid, callback, failure){
	connection.query('SELECT o.OrderId, o.UserId, t.TransactionType, ot.OrderType, m.Status, o.ExpirationDate, o.ExecutionDate, o.CreationDate, o.Asset, o.Count, o.Price, o.GameId' +
		' FROM `Order` as o JOIN Status m ON m.MarketStatusId = o.Status JOIN TransactionType t ON o.TransactionType = t.TransactionTypeId' + 
...
order.GetAllOrdersForGame = function(gameid, callback, failure){
	connection.query('SELECT o.OrderId, t.TransactionType, ot.OrderType, m.Status, o.ExpirationDate, o.ExecutionDate, o.CreationDate, o.Asset, o.Count, o.Price, o.GameId' +
		...
		' JOIN MarketStatus m.MarketMarketStatusId = o.Status WHERE o.gameid = ?', gameid, function(error, results, fields){
			if(error){
				if(failure)
					failure();
				throw error;
...
order.GetAllOrdersForUser = function(userid, callback, failure){
	connection.query('SELECT o.OrderId, t.TransactionType, ot.OrderType, m.Status, o.ExpirationDate, o.ExecutionDate, o.CreationDate, o.Asset, o.Count, o.Price, o.GameId' +
		' FROM `Order` as o JOIN Status m ON m.MarketStatusId = o.Status JOIN TransactionType t ON o.TransactionType = t.TransactionTypeId' + 
		' JOIN OrderType ot ON ot.OrderTypeId = o.OrderType' +
		' JOIN MarketStatus m.MarketMarketStatusId = o.Status WHERE o.userid = ?', userid, function(error, results, fields){
			if(error){
				if(failure)
					failure();
				throw error;
...
order.GetAllOrdersForUserGame = function(userid,gameid, callback, failure){
	connection.query('SELECT o.OrderId, t.TransactionType, ot.OrderType, m.Status, o.ExpirationDate, o.ExecutionDate, o.CreationDate, o.Asset, o.Count, o.Price, o.GameId' +
		' FROM `Order` as o JOIN Status m ON m.MarketStatusId = o.Status JOIN TransactionType t ON o.TransactionType = t.TransactionTypeId' + 
		' JOIN OrderType ot ON ot.OrderTypeId = o.OrderType' +
		' JOIN MarketStatus m.MarketMarketStatusId = o.Status WHERE o.userid = ? AND o.gameid = ?', [userid,gameid], function(error, results, fields){
			if(error){
				if(failure)
					failure();
				throw error;
